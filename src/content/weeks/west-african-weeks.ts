...
export const waWeek3Egusi: WeekPlan = {
  ...
  days: [
    ...
    { day: "Thu", dinner: "ogbono and okro combined — double draw — with fufu", estCalories: 700, estProtein: 24 },
...
export const waWeek6Plantain: WeekPlan = {
  ...
  days: [
    ...
    { day: "Tue", dinner: "boiled yam with garden-egg sauce and a fried egg", estCalories: 680, estProtein: 18 },
